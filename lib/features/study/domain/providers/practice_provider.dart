...
class PracticeState {
  ...
  int get correctCount =>
      answeredCorrectly.values.where((v) => v).length;
...
class PracticeNotifier extends StateNotifier<PracticeState> {
  ...
  PracticeNotifier(this._tutorRepository) : super(const PracticeState());

  /// Load questions — for now we use seeded mock data.
  /// In production: call QuizRepository.getQuizQuestions(quizId).
  void loadQuestions({
    ...
    // Seed mock questions for the given subject
    final questions = _getSeedQuestions(subject);
  ...
  Future<void> requestHint() async {
    ...
    if (currentHintState.hintCount >= 3) return;
    ...
    try {
      // Build context-aware hint request
...
${previousHints.isNotEmpty ? 'Hint sebelumnya yang sudah diberikan:\n$previousHints\n\nBerikan hint yang BERBEDA dan lebih spesifik.' : 'Berikan hint pertama untuk membantu siswa berpikir.'}

Ingat: JANGAN berikan jawaban langsung. Ajukan satu pertanyaan penuntun.''';
      ...
      updatedHintStates[idx] = QuestionHintState(
        hints: [...currentHintState.hints, response],
        isLoading: false,
  ...
  /// Mark the quiz as completed and compute score.
  void completeQuiz() {
  ...
  static const List<QuizQuestion> _mathQuestions = [
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Turunan f(x) = 2x² + 3x - 5 menggunakan rumus d/dx(axⁿ) = naxⁿ⁻¹.\nf\'(x) = 2(2)x¹ + 3(1)x⁰ = 4x + 3.',
    ),
    QuizQuestion(
      id: 'mtk_2',
      ...
      correctIndex: 0,
      explanation: 'Integral ∫(3x² + 2x) dx = (3/3)x³ + (2/2)x² + C = x³ + x² + C.',
    ),
    QuizQuestion(
      id: 'mtk_3',
      ...
      options: ['3', '0', '1', '1/3'],
      correctIndex: 0,
      explanation: 'Gunakan rumus lim(x→0) sin(ax)/x = a.\nMaka lim(x→0) sin(3x)/x = 3.',
    ),
    QuizQuestion(
      id: 'mtk_4',
  ...
  static const List<QuizQuestion> _physicsQuestions = [
    ...
    QuizQuestion(
      id: 'fis_2',
      question: 'Energi kinetik benda bermassa 2 kg dengan kecepatan 3 m/s adalah...',
    ...
    QuizQuestion(
      id: 'fis_3',
      question: 'Frekuensi gelombang dengan panjang gelombang 2 m dan cepat rambat 340 m/s adalah...',
    ...
    QuizQuestion(
      id: 'fis_4',
      question: 'Tegangan listrik pada hambatan 10 Ω yang dialiri arus 2 A adalah...',
    ...
    QuizQuestion(
      id: 'fis_5',
      question: 'Usaha yang dilakukan gaya 50 N yang memindahkan benda sejauh 4 m adalah...',
      options: ['200 J', '12,5 J', '54 J', '46 J'],
      correctIndex: 0,
      explanation: 'W = F × s = 50 × 4 = 200 J (asumsi gaya searah perpindahan).',
    ),
  ];
  ...
  static const List<QuizQuestion> _chemistryQuestions = [
    ...
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Na (logam) menyerahkan elektron ke Cl (non-logam) → ikatan ionik.',
    ),
    QuizQuestion(
      id: 'kim_4',
    ...
    QuizQuestion(
      id: 'kim_5',
      question: 'Gas ideal memiliki volume 2 L pada tekanan 1 atm dan suhu 273 K. Jika tekanan menjadi 2 atm pada suhu tetap, volumenya menjadi...',
      options: ['1 L', '4 L', '0,5 L', '3 L'],
      correctIndex: 0,
      explanation: 'Hukum Boyle (T tetap): P₁V₁ = P₂V₂ → 1×2 = 2×V₂ → V₂ = 1 L.',
    ),
  ];
  ...
  static const List<QuizQuestion> _biologyQuestions = [
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Nukleus (inti sel) mengandung DNA yang mengendalikan seluruh aktivitas sel.',
    ),
    QuizQuestion(
      id: 'bio_2',
      ...
      correctIndex: 0,
      explanation: 'Kloroplas mengandung klorofil yang menyerap cahaya untuk fotosintesis.',
    ),
    QuizQuestion(
      id: 'bio_3',
      ...
      correctIndex: 0,
      explanation: 'Pepsin bekerja di lambung (pH asam) untuk memecah protein menjadi pepton.',
    ),
    QuizQuestion(
      id: 'bio_4',
      question: 'Urutan hierarki taksonomi dari yang tertinggi ke terendah adalah...',
      options: [
      ...
      correctIndex: 0,
      explanation: 'Ingat: King Philip Came Over For Good Spaghetti (Kingdom, Phylum, Class, Order, Family, Genus, Species).',
    ),
    QuizQuestion(
      id: 'bio_5',
      ...
      correctIndex: 0,
      explanation: 'Vena pulmonalis membawa darah kaya O₂ dari paru-paru ke atrium kiri jantung.',
    ),
  ];
  ...
  static const List<QuizQuestion> _bahasaQuestions = [
    QuizQuestion(
      ...
      correctIndex: 0,
      explanation: 'Kata baku yang benar adalah "menganalisis" bukan "menganalisa" (KBBI edisi terbaru).',
    ),
    QuizQuestion(
      id: 'ind_2',
      ...
      correctIndex: 0,
      explanation: 'Teks prosedur berisi langkah-langkah atau tahapan untuk mencapai tujuan tertentu.',
    ),
    QuizQuestion(
      id: 'ind_3',
      ...
      correctIndex: 0,
      explanation: '"Oleh karena itu" menghubungkan kalimat sebab dengan kalimat akibat.',
    ),
    QuizQuestion(
      id: 'ind_4',
      ...
      correctIndex: 0,
      explanation: 'Teks eksposisi tersusun dari: tesis (pendapat), argumentasi (bukti), dan penegasan ulang (kesimpulan).',
    ),
    QuizQuestion(
      id: 'ind_5',
      ...
      correctIndex: 0,
      explanation: 'Judul karya ilmiah ditulis dengan huruf kapital di awal setiap kata, kecuali kata tugas (terhadap, dan, di, ke, dari) yang tidak di awal judul.',
    ),
  ];
}
...
final practiceNotifierProvider =
  ...
  return PracticeNotifier(ref.watch(tutorRepositoryProvider));
});
